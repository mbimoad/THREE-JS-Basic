...
function createHoverToPlaneGeometry(p, w, h, c, Ghsegmn, key) {
    const cw = w / c;
    const ch = h / Ghsegmn;
...
function loopingBoxToPlaneGeometry(stacked, p, w, h, c, Ghsegmn, key) {
    const cw = w / c;
    const ch = h / Ghsegmn;
...
function createGround(w, h, c, Ghsegmn) {
    const g = new THREE.Mesh(
        new THREE.PlaneGeometry(w, h, c, Ghsegmn),
