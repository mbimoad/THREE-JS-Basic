...
function createHoverToPlaneGeometry(ground, Gwidth, Gheight, Gwsegmn, Ghsegmn, key) {
    ...
    for (let i = 0; i < Gwsegmn; i++) {
        for (let j = 0; j < Ghsegmn; j++) {
            ...
            const pos   = gposi(Gwidth, Gheight, cellwidths, cellheight, boxHeight, ground, i, j, 0, key);
    ...
    for (let i = 0; i < Gwsegmn; i++) {
        for (let j = 0; j < Ghsegmn; j++) {
            for (let k = 0; k < stacked; k++) {
                ...
                const pos = gposi(Gwidth, Gheight, cellwidths, cellheight, boxHeight, ground, i, j, k, key);
