...
const camera = new THREE.PerspectiveCamera(45, widths / window.innerHeight, 0.1, 1000);
const renderer = new THREE.WebGLRenderer({ antialias: true });
camera.position.set(0, 4, 14);
camera.lookAt(0,0,0)
renderer.setSize(widths, window.innerHeight);
...
window.addEventListener('resize', () => {
    camera.aspect = widths / window.innerHeight;
