...
// Buat tangan ala Minecraft
const handGeometry = new THREE.BoxGeometry(0.3, 0.5, 0.2); // ukuran tangan
const handMaterial = new THREE.MeshBasicMaterial({ color: 0xffcc99 }); // warna kulit
const hand = new THREE.Mesh(handGeometry, handMaterial);

// Posisi tangan relatif terhadap kamera (kanan bawah layar)
hand.position.set(0.5, -0.5, -1); 
camera.add(hand); // tambahkan ke kamera, bukan scene
