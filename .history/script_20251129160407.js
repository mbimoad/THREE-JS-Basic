...
let hand;
modeloader.load('./models/hand.glb', (gltf) => {
    hand = gltf.scene;
    hand.scale.set(0.5, 0.5, 0.5); // skala sesuai kebutuhan
    hand.position.set(0.5, -0.5, -1); // geser ke kanan bawah kamera
    hand.rotation.set(0, 0, 0);
    camera.add(hand); // penting! tambahkan ke kamera
});
