...
const boxes = (w1,new GLTFLoader(); 
loader.load('./rack2/Scene.gltf', item => {
...
const aw2,w3,c,t,o) => new THREE.Mesh(new THREE.BoxGeometry(w1,w2,w3), new THREE.MeshBasicMaterial({color: c, transparent: t, opacity: o})); 
