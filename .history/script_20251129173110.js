...
const animate = () => {// Ukuran papan dalam unit Three.js
const boardWidth3D = 4;
const boardHeight3D = 2;

// Buat elemen HTML untuk CSS3DObject
const boardElement = document.createElement('div');
boardElement.style.width = '400px';    // proporsional
...
boardElement.innerHTML = '<strong>BOARD KIRI</strong>';

// Buat CSS3DObject
const board = new THREE.CSS3DObject(boardElement);

// Posisi menempel di depan dinding kiri
board.position.set(
...
// Rotasi supaya menghadap ke tengah ruangan
board.rotation.y = Math.PI / 2;

// Skala agar ukuran CSS sesuai unit Three.js
