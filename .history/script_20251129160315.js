...
const hand = new THREE.Mesh(new THREE.BoxGeometry(0.3, 0.5, 0.1), handMaterial);

// Tangan di depan kamera
hand.position.set(0.5, -0.5, -1); // X kanan, Y bawah, Z depan
hand.rotation.set(0, 0, 0);
camera.add(hand); // pastikan ditambahkan ke kamera

// Tambahkan lampu agar tangan terlihat
const handLight = new THREE.AmbientLight(0xFFFFFF, 1);
hand.add(handLight);
