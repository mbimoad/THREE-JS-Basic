...
modeload.load('./rack1/scene.gltf', item => {
    let tinggi = 0; 
    item.scene.scale.z = 1.5;
    item.scene.updateMatrixWorld(true); 
    // aku kan memperbesar racknya, tapi ukuran create hover nya tidak menyesuaikan. apa ini salah di update matrix world? 
