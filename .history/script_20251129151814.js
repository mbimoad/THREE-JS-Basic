...
wallFront.position.set(0, wallHeight / 2, gs / 2);
scenes.add(wallFront);

// --- TEMBOK BELAKANG ---
const wallBack = new THREE.Mesh(wallGeometry1, wallMaterial);
wallBack.position.set(0, wallHeight / 2, -gs / 2);
scenes.add(wallBack);

// --- TEMBOK KIRI ---
const wallLeft = new THREE.Mesh(wallGeometry2, wallMaterial);
wallLeft.position.set(-gs / 2, wallHeight / 2, 0);
scenes.add(wallLeft);

// --- TEMBOK KANAN ---
const wallRight = new THREE.Mesh(wallGeometry2, wallMaterial);
wallRight.position.set(gs / 2, wallHeight / 2, 0);
scenes.add(wallRight);
