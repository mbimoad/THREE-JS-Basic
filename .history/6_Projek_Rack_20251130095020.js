...
function planeShadowed(pos,col,row,obj) {
    const mesh = new THREE.Mesh(new THREE.PlaneGeometry(pos.x,1,col,row), new THREE.MeshBasicMaterial({color: 0xFFFFFF, wireframe: true})); 
    mesh.rotation.x = -Math.PI/2; 
    mesh.position.copy(pos.cntr); 
    scenes.add(mesh); 
    return mesh; 
}
