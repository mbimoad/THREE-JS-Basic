...
let sound1  = new THREE.Audio(audio); 
let sound2  = new THREE.PositionalAudio(audio); 
let loads1  = new THREE.AudioLoader().load('dragonball.ogg', item => {
    sound1.setBuffer(item); 
})
let loads2  = new THREE.AudioLoader().load('dragonball.ogg', item => {
