...
// Geometry
const wallGeometry1 = new THREE.BoxGeometry(gs, wallHeight, wallThickness); // depan & belakang
const wallGeometry2 = new THREE.BoxGeometry(wallThickness, wallHeight, gs); // kiri & kanan

// Helper untuk buat tembok
function createWall(geometry, x, y, z) {
...
// Buat semua tembok
createWall(wallGeometry1, 0, halfHeight,  halfGS);  // depan
createWall(wallGeometry1, 0, halfHeight, -halfGS);  // belakang
createWall(wallGeometry2, -halfGS, halfHeight, 0);  // kiri
createWall(wallGeometry2,  halfGS, halfHeight, 0);  // kanan

// -----------------------------
// Tambahkan atap
// -----------------------------
const roofHeight = 3; // tinggi atap
const roofMaterial = new THREE.MeshStandardMaterial({ color: 0x8B0000 }); // warna merah gelap

// Bentuk prisma segitiga (roof)
const roofGeometry = new THREE.ConeGeometry(halfGS * Math.sqrt(2), roofHeight, 4);
const roof = new THREE.Mesh(roofGeometry, roofMaterial);

// Rotasi agar segiempatnya sejajar dengan tembok
