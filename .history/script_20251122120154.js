...
const ch = ob.find(i => i.position.x == gh.position.x && i.position.z == gh.position.z)
scenes.add(gm,gh)
...
const updateMouse = e => {
    mousePosition.x =  (e.clientX/widths) * 2.2 - 1;
    mousePosition.y = -(e.clientY/height) * 2.2 + 1;
} 
window.addEventListener('mousemove', function(e) {
    updateMouse(e)
    raycater.setFromCamera(mousePosition, camera); 
    intersect = raycater.intersectObjects(scenes.children); 
