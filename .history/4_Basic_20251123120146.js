...
function gposi(w, Gheight, cellwidths, cellheight, boxHeight, ground, i, j, k, key) {
    return {
...
function createHoverToPlaneGeometry(ground, w, Gheight, Gwsegmn, Ghsegmn, key) {
    ...
    for (let i = 0; i < Gwsegmn; i++) {
        for (let j = 0; j < Ghsegmn; j++) {
            ...
            const pos   = gposi(w, Gheight, cellwidths, cellheight, boxHeight, ground, i, j, 0, key);
...
function loopingBoxToPlaneGeometry(stacked, ground, w, Gheight, Gwsegmn, Ghsegmn, key) {
    const cellwidths = w / Gwsegmn;
    const cellheight = Gheight / Ghsegmn;
    ...
    for (let i = 0; i < Gwsegmn; i++) {
        for (let j = 0; j < Ghsegmn; j++) {
            for (let k = 0; k < stacked; k++) {
                ...
                const pos = gposi(w, Gheight, cellwidths, cellheight, boxHeight, ground, i, j, k, key);
...
function createGround(w, Gheight, Gwsegmn, Ghsegmn) {
    const g = new THREE.Mesh(
        new THREE.PlaneGeometry(w, Gheight, Gwsegmn, Ghsegmn),
