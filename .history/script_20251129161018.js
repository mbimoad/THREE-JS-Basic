...
const handGeometry = new THREE.BoxGeometry(1, 1, 2); // ukuran tangan
const handMaterial = new THREE.MeshBasicMaterial({ color: 0xffcc99 }); // warna kulit
const hand = new THREE.Mesh(handGeometry, handMaterial);

// 2. Posisi tangan relatif terhadap kamera (kanan bawah layar)
hand.position.set(1, -1, -3); // x = kanan, y = bawah, z = ke depan

// 3. Tambahkan tangan ke kamera, bukan scene
camera.add(hand);

// 4. Pastikan kamera berada di scene
scenes.add(camera);
