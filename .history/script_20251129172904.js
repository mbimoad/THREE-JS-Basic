...
boardElement.style.width = '200px';   // lebih proporsional
...
// Posisi di sisi kiri (di depan dinding kiri)
board.position.set(
    -halfGS + wallThickness/2 + 0.01, // x: di depan dinding kiri
    halfHeight,                        // y: tengah dinding
    0                                   // z: tengah
);
