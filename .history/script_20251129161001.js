...
// 1. Lengan
const armGeometry = new THREE.BoxGeometry(1, 3, 1); // lebih panjang dari tangan
...
// 3. Posisi tangan di ujung lengan
hand.position.set(0, -2, 0); // lengan tinggi 3, jadi tangan -2 agar di bawah lengan

// 4. Gabungkan lengan + tangan
arm.add(hand);

// 5. Posisi relatif terhadap kamera
arm.position.set(1, -1, -3); // kanan bawah layar
camera.add(arm);
scenes.add(hand)
